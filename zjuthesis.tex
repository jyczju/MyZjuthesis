...
\documentclass[
    ...
    % Title
    Title           = 基于恶意物理信号的人机交互系统安全分析,
    TitleEng        = {{Secure HCI System Based on Malicious Physical Signal}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{基于恶意物理信号的}{人机交互系统安全分析}
\titleengtwolines{Secure HCI System Based on}{ Malicious Physical Signal}
% \titlethreelines{毕业论文题目第一行}{毕业论文题目第二行}{毕业论文题目第三行}
% \titleengthreelines{Security Analysis of HCI}{Interaction System Based on}{Malicious Physical Signal Injection}
